  ...
  return (
    <div className="text-gray-800">
      ...
      >
        <div className="bg-black/50 w-full h-full flex flex-col items-center justify-center">
          <h1 className="text-white text-4xl font-bold text-center px-4">
            King’s Oil Estate Phase III
          </h1>
          <span className="text-orange-500 mt-2">
            Fresh Start. Growing Community.
          </span>
        </div>
      </section>
      <section className="p-6 md:p-12 max-w-5xl mx-auto">
        ...
        <p>
          The newest development in Simawa, King's Oil Estate Phase III is an
          expansion that reflects our commitment to thoughtful planning and
          community living. It’s ideal for young families, growing investors,
          and anyone seeking a fresh start in a promising area with proven
          growth.
        </p>
      </section>
      ...
      <section className="bg-orange-500 text-white text-center py-10">
        <h3 className="text-2xl font-semibold mb-2">
          Start Fresh in Phase III
        </h3>
        <p> Join a growing community in Simawa. Reach out today.</p>
        <a
          href="/contact"
