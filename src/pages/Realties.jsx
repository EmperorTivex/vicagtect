    ...
    <div className="bg-white text-gray-900 overflow-x-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10 text-white">
          ...
          >
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-12 font-medium opacity-90 leading-relaxed">
              With Vicagtect Realties, your daily or monthly contributions grow
              with up to 33% ROI while being invested in real estate projects
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div {...fadeInUp} className="space-y-8">
            <h2 className="text-4xl font-black tracking-tight text-gray-900">
              The Reality of{" "}
              <span className="text-orange-600">Traditional Saving</span>
            </h2>
              ...
              {[
                {
                  ...
                  text: "Saving in banks often means fees and inflation eat your purchasing power.",
                },
                {
                  icon: "🏠",
                  title: "Entry Barriers",
                  text: "Real estate creates wealth, but the traditional entry point is too high for many.",
                },
                {
                  icon: "😔",
                  title: "Market Risks",
                  text: "Unverified investment opportunities can ruin financial stability.",
                },
              ].map((item, idx) => (
          ...
          >
            ...
            <h2 className="text-3xl font-black mb-8 text-orange-600">
              Our Solutions
            </h2>
            <ul className="space-y-6">
              {[
                "Guaranteed ROI up to 33%",
                ...
                >
                  <span className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-xs">
                    ✓
                  </span>
                  {text}
                </li>
            ...
            {[
              ...
              <motion.div
                ...
                className={`relative bg-white p-10 rounded-[2.5rem] shadow-xl transition-all duration-500 border ${
                  plan.featured
                    ? "border-orange-600 scale-105 shadow-orange-100 z-10"
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12">
          <motion.div
            {...fadeInUp}
            className="bg-gray-900 text-white p-12 md:p-16 rounded-[3rem] shadow-2xl"
          >
            <h2 className="text-3xl font-black mb-10 tracking-tight text-orange-500">
              Important Terms
            </h2>
              ...
              {[
                {
                  icon: "⏳",
                  title: "Maturity",
                  desc: "Payout is issued only at the completion of your selected plan.",
                },
                {
                  icon: "🚫",
                  title: "Early Exit",
                  desc: "10% administrative penalty applies and ROI is forfeited for early withdrawals.",
                },
                {
                  icon: "⏰",
                  title: "Consistency",
                  desc: "Late or inconsistent payments may affect your final ROI calculation.",
                },
                {
                  icon: "📜",
                  title: "Legal Safety",
                  desc: "A binding legal contract is signed by both parties before you begin.",
                },
              ].map((term, idx) => (
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div
                  key={idx}
                  className="bg-white border border-gray-100 p-6 rounded-2xl shadow-sm hover:shadow-orange-100 transition-all group"
                >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            {[
              {
                q: "Is my money safe?",
                a: "Yes, every contribution is legally contracted and backed by our tangible real estate assets in Simawa and other growing communities.",
              },
              {
                q: "Can I withdraw anytime?",
                a: "While we encourage finishing your plan for maximum ROI, you can withdraw early subject to a 10% penalty and forfeiture of accrued interest.",
              },
              {
                q: "What if I miss a payment?",
                a: "We understand life happens. While ROI might be slightly adjusted for inconsistency, your principal remains secure. Just resume as soon as possible.",
              },
              {
                q: "How do I make payments?",
                a: "All payments are made via official bank transfers or our approved secure payment channels for absolute transparency.",
              },
            ].map((faq, idx) => (
              <motion.div
                key={idx}
