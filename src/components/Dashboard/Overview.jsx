...
function Overview() {
  ...
  const calculateInterest = () => {
    ...
    return Math.max(
      daysElapsed > 0 ? earnedInterest : amount * 0.001,
      earnedInterest,
    );
  };
      ...
      <div className="flex items-center justify-center min-h-screen bg-gray-50 p-6">
        <div className="bg-white p-10 rounded-3xl shadow-xl max-w-md w-full text-center">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            {error ||
              `We couldn't find an investor profile for "${name}". Please contact support if you think this is a mistake.`}
          </p>
          <button
        ...
        <main className="p-4 md:p-12 overflow-y-auto">
          <div className="max-w-5xl mx-auto">
            <header className="mb-8 md:mb-12">
              <span className="text-[10px] font-black text-orange-600 uppercase tracking-[0.3em] mb-3 inline-block">
                Market Overview
              </span>
              <h1 className="text-3xl md:text-5xl font-black text-gray-900 tracking-tight mb-4 flex items-center gap-4 flex-wrap">
                Good day,{" "}
              ...
              <p className="text-gray-500 font-medium text-base md:text-lg leading-relaxed">
                Your real estate assets are currently performing at peak
                capacity.
              </p>
            </header>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 md:mb-12">
              <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col relative overflow-hidden group">
                <h2 className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-3">
                  Invested
                </h2>
                <p className="text-xl md:text-2xl font-black text-gray-900 tracking-tighter mb-1">
              ...
              <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col relative overflow-hidden group">
                ...
                <p className="text-xl md:text-2xl font-black text-orange-600 tracking-tighter mb-1">
                  ₦
                  {calculateInterest().toLocaleString(undefined, {
                ...
                <div className="text-green-600 text-[10px] font-bold">
                  +
                  {(
                    (calculateInterest() / (investor.amount || 1)) *
                    100
                  ).toFixed(2)}
                  % Total Growth
                </div>
              ...
              <div className="bg-white p-6 md:p-8 rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 flex flex-col relative overflow-hidden group">
                ...
                <div
                  className={`text-xl font-black uppercase tracking-tighter mb-1 ${
            ...
            <div className="bg-gray-900 rounded-[2.5rem] md:rounded-[3rem] p-8 md:p-12 text-white shadow-2xl shadow-orange-200/20 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-48 md:w-64 h-48 md:h-64 bg-orange-600 rounded-full blur-[80px] md:blur-[100px] opacity-20 -mr-24 md:-mr-32 -mt-24 md:-mt-32"></div>
              <div className="relative z-10">
                <h3 className="text-xl md:text-2xl font-black mb-6 md:mb-8 tracking-tight">
                  Investment Summary
                </h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 md:gap-12">
                  <div className="flex items-center gap-4 md:gap-6">
                    <div className="w-12 h-12 md:w-14 md:h-14 bg-white/10 rounded-2xl flex items-center justify-center text-xl md:text-2xl">
                      📅
                    </div>
                    <div>
